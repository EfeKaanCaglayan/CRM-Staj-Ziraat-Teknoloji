...
public  partial class AdminViewModel:ObservableObject
{
    private readonly AdminRepository _repository=new AdminRepository();
     public string WelcomeMessage =>"Hosgeldiniz Admin";
     
     [ObservableProperty] private ObservableCollection<OrgUnit> _units = new();
     ...
     [ObservableProperty] private ObservableCollection<Staff> _staffList = new();
     ...
     [ObservableProperty] private ObservableCollection<ActivityLog> _activityLogs = new();
     ...
     private void LoadUnits()
     {
         try
         {
             var list = _repository.GetAllUnits();
             Units = new ObservableCollection<OrgUnit>(list);
         }
         catch (Exception ex)
         {
             ErrorMessage = $"Hata: {ex.Message}";
     ...
     private void LoadStaff()
     {
         try
         {
             var list = _repository.GetAllStaff();
     ...
     private void LoadActivityLog()
     {
         try
         {
             var list = _repository.GetActivityLog();
             ActivityLogs = new ObservableCollection<ActivityLog>(list);
         }
         catch (Exception ex)
         {
             ErrorMessage = $"Hata: {ex.Message}";
